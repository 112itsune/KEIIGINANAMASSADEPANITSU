    ...
    entries.forEach(entry=>{
        ...
        if(entry.isIntersecting){
            ...
            setTimeout(()=>{
                ...
                if(bar.classList.contains("fullstack")){

                    bar.style.width = "65%";

                }

                if(bar.classList.contains("ai")){
...
".timeline-content,.skill-card,.hero-card"
...
const r=Math.random()*0.25+.05;

card.style.boxShadow=

`0 0 60px rgba(79,140,255,${r})`;
...
"linear-gradient(90deg,#4f8cff,#00d9ff)";
...
`scale(${1-value}) translateY(${window.scrollY*.15}px)`;
...
"drop-shadow(0 0 40px rgba(79,140,255,.25))";
...
"font-size:28px;color:#4f8cff;font-weight:bold;"
